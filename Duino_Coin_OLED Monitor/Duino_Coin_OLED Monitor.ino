 ...
 *  OLED I2C ADDRESS
 * 
 *  USE 0x3D IF SCREEN SIZE 128x32 PIXELS
 *  USE 0x3C IF SCREEN SIZE 128x64 PIXELS
 *  
 */
...
const char *ssid = "Mobitel";                 // Change this to your WiFi SSID
const char *password = "dissanayaka";         // Change this to your WiFi password
const String ducoUser = "oshan_dissanayaka";  // Change this to your Duino-Coin username
 ...
 */
    ...
    String userN = result_balance_username + userp;
    ...
    if (userN.length() <= 14) {
      ...
      char user[30];
      userN.toCharArray(user, 12);
      String userLast = user;
      userLast += "...";
